;;; jenkinsfile-mode-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "jenkinsfile-mode" '("jenkinsfile-mode-")))
